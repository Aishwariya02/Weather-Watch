...
def enter_notes():
    ...
    Button(Notes,text="Ok",font=("Comic Sans MS",10),command=store_notes, width=5).place(x=15,y=100)
    Button(Notes, text="Back", font=("Comic Sans MS", 10), command=delete_notes, width=5).place(x=330,y=100)
